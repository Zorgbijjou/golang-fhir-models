...
func (r CommunicationRequest) GetExtensions() []Extension {
	return r.Extension
}
func (r CommunicationRequest) SetExtensions(extensions []Extension) {
	r.Extension = extensions
}

var _ HasExtension = (*CommunicationRequest)(nil)
